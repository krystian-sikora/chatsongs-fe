...
<template>
  <svg :fill="color ? color : '#000000'" :stroke="color ? color : '#000000'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    <g id="SVGRepo_iconCarrier">
      <path
          ...
          :stroke="color ? color : '#000000'" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></path>
    </g>
  </svg>
</template>
